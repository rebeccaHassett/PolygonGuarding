...
public class GuardGame extends PApplet {
...
public void getGuardsAdjacentVertices()
{
...
public boolean InCone(Vertex a, Vertex b)
{
  Vertex aNext = a;
  Vertex aPrev = a;
...
public boolean checkIntersections(float x1, float y1, float x2, float y2) {
...
/* Signed area of triangle determined by a,b,c; positive if counterclockwise and negative if clockwise */
  public float AreaSign(Vertex a, Vertex b, Vertex c)
  {
    float area;
  ...
  /* Left Test */
  public boolean Left(Vertex a, Vertex b, Vertex c)
  {
  ...
  public boolean LeftInterior(Vertex a, Vertex b, Vertex c) 
  {
   return AreaSign(a,b,c) > 0; 
  }
  
  /* Left of or on Line Segment */
  public boolean LeftOn(Vertex a,Vertex b, Vertex c)
  {
   return AreaSign(a,b,c) >= 0; 
  }
  ...
  public boolean IntersectProp(Vertex a, Vertex b, Vertex c, Vertex d)
  { 
    return Xor( Left(a,b,c), Left(a,b,d) ) && Xor ( Left(c,d,a), Left(c,d,b)); 
  }
  
  public boolean samePoint(Vertex v1, Vertex v2)
  {
    if (abs(v1.x - v2.x) < 0.01f && abs(v1.y - v2.y) < 0.01f){
      return true;
    } else {
      return false;
    }
  ...
  public boolean lineintersection(Vertex a, Vertex b, Vertex c, Vertex d)
  {
     /* test */
...
class Vertex {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "GuardGame" };
    if (passedArgs != null) {
